...
#if len(sys.argv) == 1:
#  print "usage: hypernetwork-speaker.py \"filename\""
#  exit(1)
...
for fname in file_names:
 myfile = codecs.open(fname + ".txt", 'r', 'utf-8')
 ...
 for line in myfile:
  ...
  for (w, tag) in nltk.pos_tag(nltk.word_tokenize(line)):
   if tag != 'NN': continue
